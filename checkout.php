...
<form action="" method="post">
   ...
   <input type="hidden" name="name" value="<?= $fetch_profile['fname'] ?>&nbsp;<?= $fetch_profile['lname'] ?>">
   ...
   <div class="user-info">
      <h3>your info</h3>
      <p><i class="fas fa-user"></i><span><?= $fetch_profile['fname'] ?>&nbsp;<span><?= $fetch_profile['lname'] ?></span></p>
